        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <Link href="/courses" className="px-8 py-4 text-lg font-medium text-center text-white bg-indigo-600 rounded-md">
                Enroll Now
              </Link>
              <Link href="/contact" className="px-8 py-4 text-lg font-medium text-center text-indigo-600 bg-white border-2 border-indigo-600 rounded-md">
                About Us
              </Link>
            </div>
          </div>
